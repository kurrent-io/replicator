---
title: "Docker"
description: Running Replicator with Docker Compose
---
...
We prepared a complete set of files for this scenario. You find those files in the [Replicator repository](https://github.com/kurrent-io/replicator/tree/master/compose).
